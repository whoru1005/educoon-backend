...
import com.educoon.domain.roomParticipant.dto.RoomParticipantResponse;
...
import com.educoon.domain.studyRoom.dto.StudyRoomSummaryResponse;
import com.educoon.domain.studyRoom.dto.StudyRoomUpdateRequest;
...
public class StudyRoomService {
    ...
    public void joinRoom(Long roomId, String currentUserKakaoId, String password){
        ...
        StudyRoom studyRoom = studyRoomRepository.findByWithLock(roomId)
                .orElseThrow(() -> new CustomException(ErrorCode.ROOM_NOT_FOUND));
